...
class CalendarService {
  ...
  Future<Map<String, CalendarOverride>> getAllOverridesMap() async {
    final list = await _dbHelper.getAllOverrides();
    return {for (var o in list) o.date: o};
  }

  Future<void> preloadYearConfig(int year) async {
    final cached = await _holidaySyncService.getLocalSyncedConfig(year);
    if (cached != null) {
      HolidayData.updateConfigForYear(cached);
    }
  }
