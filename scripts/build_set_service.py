...
settings_service_code = """import '../database/database_helper.dart';
...
with open('lib/services/settings_service.dart', 'w', encoding='utf-8') as f:
    f.write(settings_service_code.strip() + '\n')
print('SettingsService generated.')
