...
calendar_test = """import 'package:flutter_test/flutter_test.dart';
import 'package:dalema/constants/holiday_data.dart';
...
with open('test/calendar_rules_test.dart', 'w', encoding='utf-8') as f:
    f.write(calendar_test.strip() + '\n')
print('calendar_rules_test written.')
