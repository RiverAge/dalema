...
attendance_test = """import 'package:flutter_test/flutter_test.dart';
...
with open('test/attendance_test.dart', 'w', encoding='utf-8') as f:
    f.write(attendance_test.strip() + '\n')
print('attendance_test written.')
