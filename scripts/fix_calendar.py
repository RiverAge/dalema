...
calendar_code = """import 'package:flutter/material.dart';
    ...
    return GlassCard(
      ...
      child: Row(
        ...
        children: [
          ...
          Container(width: 1, height: 28, color: Colors.grey.withValues(alpha: 0.2)),
          _buildMetricPill('休假天数', '$_restDays天', AppTheme.primaryBlue, Icons.weekend_rounded),
        ],
      ),
    );
  }
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: isSelected
                ...
                : (day.isToday ? AppTheme.primaryBlue.withValues(alpha: 0.12) : Colors.transparent),
            borderRadius: BorderRadius.circular(16),
              ...
              if (badgeText != null && day.isCurrentMonth)
                Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: isSelected ? Colors.white.withValues(alpha: 0.35) : badgeColor.withValues(alpha: 0.15),
...
with open('lib/screens/history_screen.dart', 'w', encoding='utf-8') as f:
    f.write(calendar_code.strip() + '\n')

print('history_screen centering and smooth month transitions fixed.')
