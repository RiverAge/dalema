...
attendance_service_code = """import 'package:intl/intl.dart';
...
with open('lib/services/attendance_service.dart', 'w', encoding='utf-8') as f:
    f.write(attendance_service_code.strip() + '\n')
print('AttendanceService generated.')
